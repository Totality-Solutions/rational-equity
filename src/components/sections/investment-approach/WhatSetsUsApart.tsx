        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-10 md:mb-16 leading-tight"
            >
              What Sets Us Apart
              <div
                className="w-[11%] h-[2px] bg-[#8B0000] mt-4 transition-all duration-500 ease-in-out block"
              />
            </motion.h2>
          ...
          <div className="order-1 lg:order-2 relative flex justify-center items-center">
            <div className="relative w-full aspect-square max-w-[400px] md:max-w-[500px] overflow-hidden rounded-2xl bg-white/[0.03] border border-white/5">
              <AnimatePresence initial={false} mode="popLayout">
                <motion.img
                  key={`${activeItem.id}-${imgIndex}`}
                  src={currentImageSrc}
