...
//               viewport={{ once: true }}
//               className="bg-white/50 backdrop-blur-sm p-12 rounded-2xl border border-gray-50 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 text-center"
//             >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {features.map((item, i) => (
            <motion.div
              ...
              transition={{ delay: i * 0.1, duration: 0.8 }}
              viewport={{ once: true }}
              className="bg-white/50 backdrop-blur-sm p-8 lg:p-12 rounded-2xl border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 text-center flex flex-col items-center group"
            >
              <div className="mb-8 text-[#8B0000] transition-transform duration-500 group-hover:scale-110">
                {item.icon}
              </div>
              <h4 className="font-sans font-bold text-gray-900 mb-6 text-lg lg:text-xl tracking-tight">
                {item.title}
              </h4>
              <p className="font-sans text-gray-500 leading-relaxed text-sm lg:text-base px-2">
                {item.desc}
              </p>
            </motion.div>
          ))}
