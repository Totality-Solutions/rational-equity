              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="text" placeholder="Your name" className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 focus:outline-none focus:ring-1 focus:ring-brand-maroon transition-all text-sm" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[13px] font-semibold text-[#000000]/50 uppercase tracking-wider">Email *</label>
                    <input required type="email" placeholder="email@example.com" className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 focus:outline-none focus:ring-1 focus:ring-brand-maroon transition-all text-sm" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="text" placeholder="+91 XXXXX XXXXX" className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 focus:outline-none focus:ring-1 focus:ring-brand-maroon transition-all text-sm" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[13px] font-semibold text-[#000000]/50 uppercase tracking-wider">Interested Fund (optional)</label>
                    <input type="text" placeholder="Select a fund" className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 focus:outline-none focus:ring-1 focus:ring-brand-maroon transition-all text-sm" />
                  </div>
                </div>
          ...
          <motion.div custom={1} variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 text-sm text-[#000000]/50 text-left">
                  <MapPin size={18} className="text-brand-maroon shrink-0 mt-0.5" />
                  <p>123 Financial District, Mumbai,<br />Maharashtra 400001</p>
                </div>
                <div className="flex items-center gap-4 text-sm text-[#000000]/50 text-left">
                  <Phone size={18} className="text-brand-maroon shrink-0" />
                  <p>+91 22 1234 5678</p>
                </div>
              </div>
              <a href="#" className="inline-flex items-center gap-2 text-brand-maroon font-bold text-sm pt-4 hover:gap-3 transition-all">View on Google Maps <ArrowRight size={14} /></a>
            </div>
          </motion.div>
        </div>
      </div>
